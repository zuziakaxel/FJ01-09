...
\begin{figure}[h!]
	...
	\centering
	\resizebox{0.7\textwidth}{!}{\input{plateau}}	
...
\begin{figure}[h!]
	\fontsize{6}{8}\selectfont % zmniejszam czcionke
	\centering
	\resizebox{0.9\textwidth}{!}{\input{histogram1}}	
	\label{hist1}	
...
\begin{figure}[h!]
	\fontsize{6}{8}\selectfont % zmniejszam czcionke
	\centering
	\resizebox{0.8\textwidth}{!}{\input{histogram2.tex}}
...
\begin{figure}[h!]
	\fontsize{6}{8}\selectfont % zmniejszam czcionke
	\centering
	\resizebox{0.9\textwidth}{!}{\input{histogram3.tex}}
...
\begin{figure}[h!]
	\fontsize{6}{8}\selectfont % zmniejszam czcionke
	\centering
	\resizebox{1.0\textwidth}{!}{\input{srebro.tex}}	
